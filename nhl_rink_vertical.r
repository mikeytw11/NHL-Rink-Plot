...
nhl_rink_vertical <- function () {
  ...
  ggplot() +
    ...
    # Referee crease
    geom_arc(aes(y0 = 0, x0 = -42.5, start = 0, end = pi, r = 10), color = NHL_red) +
    ...
    geom_line(aes(y = c(-72, 72), x = c(42.5, 42.5))) + # Right
    geom_line(aes(y = c(-72, 72), x = c(-42.5, -42.5))) + # Left
